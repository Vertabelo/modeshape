 ...
 */
package org.modeshape.sequencer.ddl.dialect.postgres10plus;
...
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.COLUMN_IDENTITY;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.COLUMN_IDENTITY_OPTIONS;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.CONCURRENTLY;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.CREATE_VIEW_QUERY_EXPRESSION;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.FUNCTION_PARAMETER_MODE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.INDEX_TABLESPACE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.PARTITION_BOUND;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.PARTITION_BY;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.PARTITION_OF;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.PROPERTY_VALUE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.ROLE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SCHEMA_NAME;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_CACHE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_CYCLE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_DATA_TYPE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_INCREMENT_BY;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_MAX_VALUE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_MIN_VALUE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_NO_MAX_VALUE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_NO_MIN_VALUE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_OWNED_BY;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.SEQ_START_WITH;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TABLESPACE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TABLE_NAME;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ABORT_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_AGGREGATE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_CONVERSION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_DATABASE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_FOREIGN_DATA_WRAPPER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_FUNCTION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_GROUP_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_INDEX_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_LANGUAGE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_OPERATOR_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_ROLE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_SCHEMA_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_SEQUENCE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_SERVER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_TABLESPACE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_TABLE_STATEMENT_POSTGRES;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_TEXT_SEARCH_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_TRIGGER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_TYPE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_USER_MAPPING_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_USER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ALTER_VIEW_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ANALYZE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CLUSTER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_COMMENT_ON_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_COMMIT_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CONSTRAINT_ATTRIBUTE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_COPY_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_AGGREGATE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_CAST_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_CONSTRAINT_TRIGGER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_CONVERSION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_DATABASE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_FOREIGN_DATA_WRAPPER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_FUNCTION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_GROUP_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_INDEX_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_LANGUAGE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_OPERATOR_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_ROLE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_RULE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_SEQUENCE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_SERVER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_TABLESPACE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_TEXT_SEARCH_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_TRIGGER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_TYPE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_USER_MAPPING_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_USER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_CREATE_VIEW_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DEALLOCATE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DECLARE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_AGGREGATE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_CAST_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_CONSTRAINT_TRIGGER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_CONVERSION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_DATABASE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_FOREIGN_DATA_WRAPPER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_FUNCTION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_GROUP_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_INDEX_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_LANGUAGE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_OPERATOR_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_OWNED_BY_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_ROLE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_RULE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_SEQUENCE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_SERVER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_TABLESPACE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_TEXT_SEARCH_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_TRIGGER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_TYPE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_USER_MAPPING_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_DROP_USER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_EXPLAIN_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_FETCH_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_FUNCTION_PARAMETER;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_DATABASE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_FOREIGN_DATA_WRAPPER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_FOREIGN_SERVER_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_FUNCTION_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_LANGUAGE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_SCHEMA_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_SEQUENCE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ON_TABLESPACE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_GRANT_ROLES_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_LISTEN_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_LOAD_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_LOCK_TABLE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_MOVE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_NOTIFY_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_PREPARE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_REASSIGN_OWNED_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_REINDEX_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_RELEASE_SAVEPOINT_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_RENAME_COLUMN;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_REVOKE_ON_SCHEMA_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_ROLLBACK_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_SELECT_INTO_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_SHOW_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_TRUNCATE_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_UNLISTEN_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.TYPE_VACUUM_STATEMENT;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.UNIQUE_INDEX;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.UNLOGGED;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.USING;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.WHERE_CLAUSE;
import static org.modeshape.sequencer.ddl.dialect.postgres10plus.Postgres10PlusDdlLexicon.WITH_OPTIONS;

/**
 * Postgres-specific DDL Parser for versions 10+ of PostgreSQL. Includes custom data types as well as custom DDL statements.
 */
public class Postgres10PlusDdlParser extends StandardDdlParser
    implements Postgres10PlusDdlConstants, Postgres10PlusDdlConstants.PostgresStatementStartPhrases {

    /**
     * The Postress parser identifier.
     */
    public static final String ID = "POSTGRES_10PLUS";
    public static final int TRIES_OF_PARSE = 1000;

    static List<String[]> postgresDataTypeStrings = new ArrayList<>();

    private static final String TERMINATOR = ";";

    public Postgres10PlusDdlParser() {
        setDatatypeParser(new Postgres10PlusDataTypeParser());
        initialize();
    }
    ...
    private void parseAlterTableAction( DdlTokenStream tokens,
        ...
        if (tokens.canConsume("ADD")) { // ADD COLUMN
            ...
            } else if(tokens.canConsume("DROP", "IDENTITY") || tokens.canConsume("DROP", "IDENTITY", "IF", "EXIST")) {

            } else if(tokens.canConsume("ADD", "GENERATED")) {
                if(tokens.matches("ALWAYS")) {
                    String columnIdentity = tokens.consume();
                    columnNode.setProperty(COLUMN_IDENTITY, columnIdentity);
                } else if(tokens.matches("BY", "DEFAULT")) {
                    tokens.consume();
                    tokens.consume();
                    columnNode.setProperty(COLUMN_IDENTITY, "BY DEFAULT");
                }
        ...
        } else if (tokens.matches("ATTACH", "PARTITION") || tokens.matches("DETACH", "PARTITION")) {
            if(tokens.canConsume("ATTACH", "PARTITION")) {
                // ATTACH PARTITION partition_name FOR VALUES partition_bound_spec
                AstNode optionNode = nodeFactory().node("action", alterTableNode, TYPE_STATEMENT_OPTION);
                String partitionName = parseName(tokens);
                tokens.consume("FOR", "VALUES");
                ...
                StringBuilder partitionBound = new StringBuilder();
                if(tokens.canConsume("IN")) {
                    partitionBound.append("IN (");
                    String inExpression = parseContentBetweenParens(tokens);
                    partitionBound.append(inExpression);
                    partitionBound.append(")");
                } else if(tokens.canConsume("FROM")) {
                    partitionBound.append("FROM (");
                    String fromExpression = parseContentBetweenParens(tokens);
                    partitionBound.append(fromExpression);
                    partitionBound.append(") TO (");

                    tokens.consume("TO");

                    String toExpression = parseContentBetweenParens(tokens);
                    partitionBound.append(toExpression);
                    partitionBound.append(")");
                }
                optionNode.setProperty(VALUE, "ATTACH PARTITION " + partitionName + " FOR VALUES " + partitionBound.toString());
            } else if(tokens.canConsume("DETACH", "PARTITION")) {
                // DETACH PARTITION partition_name
                AstNode optionNode = nodeFactory().node("action", alterTableNode, TYPE_STATEMENT_OPTION);
                String partitionName = parseName(tokens);
                optionNode.setProperty(VALUE, "DETACH PARTITION " + partitionName);
            }
    ...
    protected void parseNextCreateTableOption( DdlTokenStream tokens,
        ...
        if (tokens.canConsume("ON", "COMMIT")) {
        ...
        } else if(tokens.matches("PARTITION", "BY") || tokens.matches("PARTITION", "OF")) {
            // [ PARTITION BY { RANGE | LIST } ( { column_name | ( expression ) } [ COLLATE collation ] [ opclass ] [, ... ] ) ]
            if(tokens.canConsume("PARTITION", "BY")) {
                StringBuilder partitionBy = new StringBuilder();
                if(tokens.matches("RANGE")) {
                    tokens.consume("RANGE");
                    partitionBy.append("RANGE (");
                } else if(tokens.matches("LIST")) {
                    tokens.consume("LIST");
                    partitionBy.append("LIST (");
                }

                String partitionByExpression = parseContentBetweenParens(tokens);
                partitionBy.append(partitionByExpression);
                partitionBy.append(")");
                parentNode.setProperty(PARTITION_BY, partitionBy.toString());
            }
            ...
            //    [, ... ]
            //) ] FOR VALUES partition_bound_spec
            if(tokens.canConsume("PARTITION", "OF")) {
                StringBuilder partitionOf = new StringBuilder();

                String parentTableName = parseName(tokens);
                partitionOf.append(parentTableName);
                if(tokens.matches(L_PAREN)) {
                    String partitionOfTableExpression = parseContentBetweenParens(tokens);
                    partitionOf.append(" (");
                    partitionOf.append(partitionOfTableExpression);
                    partitionOf.append(")");
                }
                parentNode.setProperty(PARTITION_OF, partitionOf.toString());

                // IN ( { numeric_literal | string_literal | TRUE | FALSE | NULL } [, ...] ) |
                // FROM ( { numeric_literal | string_literal | TRUE | FALSE | MINVALUE | MAXVALUE } [, ...] )
                //  TO ( { numeric_literal | string_literal | TRUE | FALSE | MINVALUE | MAXVALUE } [, ...] )
                if(tokens.canConsume("FOR", "VALUES")) {
                    StringBuilder partitionBound = new StringBuilder();
                    if(tokens.canConsume("IN")) {
                        partitionBound.append("IN (");
                        String inExpression = parseContentBetweenParens(tokens);
                    ...
                    parentNode.setProperty(PARTITION_BOUND, partitionBound.toString());
                }
            }
        }
    }
    ...
    protected boolean areNextTokensCreateTableOptions( DdlTokenStream tokens ) throws ParsingException {
        ...
        if (tokens.matches("ON", "COMMIT") || tokens.matches("TABLESPACE") || tokens.matches("WITH")
                ...
                || tokens.matches("PARTITION") || tokens.matches("OF") || tokens.matches("BY")
                || tokens.matches("FOR") || tokens.matches("VALUES")) {
            result = true;
        }
    ...
    protected AstNode parseCreateViewStatement( DdlTokenStream tokens,
        ...
        createViewNode.setProperty(Postgres10PlusDdlLexicon.MATERIALIZED, isMaterialized);
        ...
        if (tokens.canConsume("WITH")) {
            ...
            createViewNode.setProperty(Postgres10PlusDdlLexicon.WITH_CHECK_OPTION, withCheckOption);
        }
        ...
        if (queryExpression.toUpperCase().endsWith("WITH CHECK OPTION")) {
            ...
            createViewNode.setProperty(Postgres10PlusDdlLexicon.WITH_CHECK_OPTION, "CASCADED");
            ...
            createViewNode.setProperty(Postgres10PlusDdlLexicon.WITH_CHECK_OPTION, "LOCAL");
        }
    ...
    private AstNode parseCommentStatement( DdlTokenStream tokens,
        ...
        if (objectName != null) {
            ...
            commentNode.setProperty(Postgres10PlusDdlLexicon.TARGET_OBJECT_NAME, objectName);
        } else {
            commentNode = nodeFactory().node("commentOn", parentNode, TYPE_COMMENT_ON_STATEMENT);
        }
        commentNode.setProperty(Postgres10PlusDdlLexicon.COMMENT, commentString);
        commentNode.setProperty(Postgres10PlusDdlLexicon.TARGET_OBJECT_TYPE, objectType);
    ...
    private void parseIndexColumnExpressionList( final String columnExpressionList,
        ...
        if (!tokens.matches(R_PAREN)) {
            ...
            if (!possibleColumns.isEmpty()) {
                ...
                final boolean tableIndex = indexNode.hasMixin(Postgres10PlusDdlLexicon.TYPE_CREATE_INDEX_STATEMENT);

                // find appropriate table nodes
                if (tableIndex) {
                    // table index so find table node
                    final String tableName = (String)indexNode.getProperty(Postgres10PlusDdlLexicon.TABLE_NAME);
                    ...
                    if (!nodes.isEmpty()) {
                        if (nodes.size() == 1) {
                            ...
                            for (final AstNode node : nodes) {
                                if (node.hasMixin(Postgres10PlusDdlLexicon.TYPE_CREATE_TABLE_STATEMENT)) {
                    ...
                    // must be bitmap-join
                    tableNodes = indexNode.getChildren(Postgres10PlusDdlLexicon.TYPE_TABLE_REFERENCE);
                }
                    ...
                    for (String possibleColumn : possibleColumns) {
                        ...
                        if (tableIndex) {
                            if (tableNodes.isEmpty()) {
                                ...
                                final List<AstNode> columnNodes = tableNode.getChildren(Postgres10PlusDdlLexicon.TYPE_COLUMN_DEFINITION);
                                ...
                                if (!columnNodes.isEmpty()) {
                                    ...
                                    for (final AstNode colNode : columnNodes) {
                                        if (colNode.getName().toUpperCase().equals(possibleColumn.toUpperCase())) {
                                            ...
                                            if (asc || desc) {
                                                colRef.addMixin(Postgres10PlusDdlLexicon.TYPE_INDEX_ORDERABLE);

                                                if (asc) {
                                                    colRef.setProperty(Postgres10PlusDdlLexicon.INDEX_ORDER, "ASC");
                                                } else {
                                                    colRef.setProperty(Postgres10PlusDdlLexicon.INDEX_ORDER, "DESC");
                                                }
                                            }
            ...
            if (!functions.isEmpty()) {
                indexNode.setProperty(Postgres10PlusDdlLexicon.OTHER_REFS, functions);
            }
        }
    ...
    protected AstNode parseCreateSequenceStatement(final DdlTokenStream tokens, final AstNode parentNode)
        ...
        while (tokens.hasNext() && !isTerminator(tokens) && lastMatched) {
            ...
            if(tokens.canConsume("AS")) {
                ...
                sequenceNode.setProperty(SEQ_DATA_TYPE, value);

            } else if(tokens.canConsume("INCREMENT", "BY") || tokens.canConsume("INCREMENT")) {
                String value = tokens.consume();
    ...
    class Postgres10PlusDataTypeParser extends DataTypeParser {
        ...
        protected DataType parseCustomType( DdlTokenStream tokens ) throws ParsingException {
            ...
            if (tokens.matches(PostgresDataTypes.DTYPE_FLOAT4) || tokens.matches(PostgresDataTypes.DTYPE_FLOAT8)) {
                ...
                || tokens.matches(PostgresDataTypes.DTYPE_JSONB) || tokens.matches(PostgresDataTypes.DTYPE_MACADDR8)) {
                typeName = tokens.consume();
                result = new DataType(typeName);
            }
