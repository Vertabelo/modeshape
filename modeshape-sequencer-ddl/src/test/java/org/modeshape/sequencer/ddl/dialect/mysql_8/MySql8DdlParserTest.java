 ...
 * @author Marek Berkan
 */
public class MySql8DdlParserTest extends DdlParserTestHelper {

    public static final String DDL_FILE_PATH = "ddl/dialect/mysql_8/";
    ...
    public void parseAlterTableOption() {
        ...
        assertTrue(hasMixinType(tableNode, TYPE_ALTER_TABLE_STATEMENT));
